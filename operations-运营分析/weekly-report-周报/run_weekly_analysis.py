...
def main():
    ...
    df1.to_csv(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'result_shop_avg.csv'), index=False, encoding='utf-8-sig')
    ...
    df2.to_csv(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'result_user_structure.csv'), index=False, encoding='utf-8-sig')
    ...
    df3.to_csv(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'result_wow_change.csv'), index=False, encoding='utf-8-sig')
