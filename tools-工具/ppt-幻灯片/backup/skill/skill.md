...
6. 输出到 `~/Vibe coding/operations-运营分析/output-产出/`
...
ppt.save(os.path.expanduser("~/Vibe coding/operations-运营分析/output-产出/报告.pptx"))
```
...
- **尺寸**：26.67" x 15.0"
- **输出目录**：`~/Vibe coding/operations-运营分析/output-产出/`
